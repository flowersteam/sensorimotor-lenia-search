...
from sensorimotorleniasearch.explorers import IMGEPExplorer_random_initialized, BoxGoalSpace
...
if __name__ == '__main__':
    ...
    ## Load imgep explorer
    explorer_config = IMGEPExplorer_random_initialized.default_config()
    ...
    explorer = IMGEPExplorer_random_initialized(system, exploration_db, goal_space, config=explorer_config)
