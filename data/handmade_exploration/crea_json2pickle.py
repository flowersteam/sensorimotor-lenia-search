...
if save_animals:
    ...
    for animal_data_entry in animals_data:
        ...
        if 'params' in animal_data_entry:
            ...
            crea_filepath = f'parameters/{animal_data_entry["name"]}.pickle'
...
if prefilter:
    ...
    for crea_filename in os.listdir("./parameters"):
        if crea_filename[-7:] == ".pickle":
            crea_filepath = "./parameters/" + crea_filename
            valid_crea_filepath = "./parameters/valid_after_prefilter/" + crea_filename
            non_valid_crea_filepath = "./parameters/non_valid_after_prefilter/" + crea_filename
