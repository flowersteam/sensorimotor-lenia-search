...
def get_system_config():
    system_config = Dict()
    system_config.final_step = <final_step>
    system_config.nb_c = 1
    system_config.nb_k = 10
    system_config.SX = <SX>
    system_config.SY = <SY>
    system_config.wall_c = bool(<wall_c>)
...
def get_stat_config():
    ...
    stat_config.categories_filter = Dict(<categories_filter>)

    stat_config.dset_name = dset_name
    stat_config.var_name = "<var_name>"

    stat_config.init_noise_rate = Dict()
    stat_config.init_noise_rate.range = list(<init_noise_rate_range>)
    ...
    stat_config.init_noise_std.range = list(<init_noise_std_range>)
    ...
    stat_config.obstacle_number.range = list(<obs_number_range>)
    ...
    stat_config.obstacle_radius.range = list(<obs_radius_range>)
    ...
    stat_config.obstacle_speed.range = list(<obs_speed_range>)
    ...
    stat_config.scaling.range = <scaling_range>
    ...
    stat_config.update_mask_rate.range = list(<update_mask_rate_range>)
    ...
    stat_config.update_noise_rate.range = list(<update_noise_rate_range>)
    ...
    stat_config.update_noise_std.range = list(<update_noise_std_range>)
