...
pf="../../experiment_001000/repetition_00000"+str(seed)  
...
for i in range(160):
    ...
    if(observations[-1,:,:,0].sum()<6400 and observations[-1,:,:,0].sum()>0):
        ...
        torch.save(crea,os.environ["ALL_CCFRSCRATCH"]+"/sensorimotor_lenia/resources/curi_no_imgep_nomuta_init_exploration/parameters/seed"+str(seed)+"_crea"+crea_nb+".pickle")
        count=count+1
