...
pf="../../experiment_000000/repetition_00000"+str(seed)  
...
for i in range(160):
    ...
    if(observations[-1,:,:,0].sum()<6400 and observations[-1,:,:,0].sum()>0):
        ...
        torch.save(crea,os.environ["ALL_CCFRSCRATCH"]+"/sensorimotor_lenia/resources/imgep_exploration/seed"+str(seed)+"_crea"+crea_nb+".pickle")
        count=count+1
