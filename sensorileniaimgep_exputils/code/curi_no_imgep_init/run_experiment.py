...
from sensorimotorleniasearch.explorers import CURIExplorer_initialized, BoxGoalSpace
...
if __name__ == '__main__':
    ...
    ## Load imgep explorer
    explorer_config = CURIExplorer_initialized.default_config()
    ...
    explorer = CURIExplorer_initialized(system, exploration_db, goal_space, config=explorer_config)
