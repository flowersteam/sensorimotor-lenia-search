...
from sensorimotorleniasearch.explorers import CURIExplorer, BoxGoalSpace
...
if __name__ == '__main__':
    ...
    ## Load imgep explorer
    explorer_config = CURIExplorer.default_config()
    ...
    explorer = CURIExplorer(system, exploration_db, goal_space, config=explorer_config)
