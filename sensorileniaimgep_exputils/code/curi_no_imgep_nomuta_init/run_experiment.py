...
from sensorimotorleniasearch.explorers import CURIExplorer_nomuta_initialized, BoxGoalSpace
...
if __name__ == '__main__':
    ...
    ## Load imgep explorer
    explorer_config = CURIExplorer_nomuta_initialized.default_config()
    ...
    explorer = CURIExplorer_nomuta_initialized(system, exploration_db, goal_space, config=explorer_config)
