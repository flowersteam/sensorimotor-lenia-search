...
from sensorimotorleniasearch.explorers import IMGEPExplorer_no_grad_initialized, BoxGoalSpace
...
if __name__ == '__main__':
    ...
    ## Load imgep explorer
    explorer_config = IMGEPExplorer_no_grad_initialized.default_config()
    ...
    explorer = IMGEPExplorer_no_grad_initialized(system, exploration_db, goal_space, config=explorer_config)
